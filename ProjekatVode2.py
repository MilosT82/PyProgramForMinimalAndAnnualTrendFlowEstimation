...
s1.to_excel("VodeOutput.xls", index=False)
...
kord=pd.read_excel('kordinate.xlsx', sheet_name='kord')
kord.head(5)
...
# ### Saving merged dataframe to Excel file without index

# In[31]:


newdf.to_excel("ZavrsniOutput.xls", index=False)
